...
import { removeBlogPost, setBlogPublished } from "./actions";
...
export function PostRowActions({
  ...
  function togglePublished() {
    startTransition(async () => {
      try {
        await setBlogPublished(id, !isPublished);
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {isPublished && (
            <DropdownMenuItem
              render={<a href={`/blogs/${slug}`} target="_blank" rel="noreferrer" />}
            >
              View post
            </DropdownMenuItem>
          )}
          <DropdownMenuItem onClick={togglePublished} disabled={pending}>
